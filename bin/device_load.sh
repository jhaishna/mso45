...
ott_device_load()
{
         echo "runnng" > mta_job_device_ott.txt
         mso_mta_job_processor -verbose -object_type /mso_mta_job/device/ott

#         pid=$(cat mta_job_device_modem.txt)
#         wait $pid
         rm mta_job_device_ott.txt;
}


ip_camera_device_load()
{
         echo "runnng" > mta_job_device_ip_camera.txt
         mso_mta_job_processor -verbose -object_type /mso_mta_job/device/ip_camera

#         pid=$(cat mta_job_device_modem.txt)
#         wait $pid
         rm mta_job_device_ip_camera.txt;
}
...
#       fi
       ...
       echo " Executing ott_device_load "
       ott_device_load
fi

log_check_function "ott"
device_load_log_clean_bup



if [ -e mta_job_device_ip_camera.txt ]
then
       #echo "file is available";
#       pid1=$(cat mta_job_device_modem.txt)
#
...
#       fi
       ...
       echo " Executing ip_camera_device_load "
       ip_camera_device_load
fi

log_check_function "ip_camera"
device_load_log_clean_bup
