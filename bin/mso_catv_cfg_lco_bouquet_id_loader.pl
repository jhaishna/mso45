...
#LCO_ACC_PDP,AREA_CODE,BOUQUET_ID_NDS,BOUQUET_ID_HD_NDS,BOUQUET_ID_VM,BOUQUET_ID_HD_VM,BOUQUET_ID_JVM,BOUQUET_ID_HD_JVM,BOUQUET_ID_NAGRA1,BOUQUET_ID_HD,POP_ID,$BQ_CAT,$BQ_SUB_CAT,$NW_CAT,$NW_SUB_CAT
#33711557254,1,57973,57973,57973,57973,25205,25205,0002
...
while ($line) 
{
    ...
    else 
    {
        ...
        ($ACC_PDP,$AREA_CODE,$BOUQUET_ID1,$BOUQUET_ID_HD1,$BOUQUET_ID2,$BOUQUET_ID_HD2,$BOUQUET_ID3,$BOUQUET_ID_HD3,$BOUQUET_ID4,$BOUQUET_ID_HD4,$POP_ID,$BQ_CAT,$BQ_SUB_CAT,$NW_CAT,$NW_SUB_CAT) = split(/,/, $line);
...
1     MSO_FLD_NETWORK_NODE    STR [0] "JVM"
1     MSO_FLD_POPULATION_ID    STR [0] "$POP_ID"
1     PIN_FLD_CATEGORY_ID     INT [0] 0
1     PIN_FLD_CATEGORY_VERSION    INT [0] 0
1     PIN_FLD_REASON_DOMAIN_ID    INT [0] 0
...
1     MSO_FLD_NETWORK_NODE    STR [0] "NAGRA1"
1     MSO_FLD_POPULATION_ID    STR [0] "$POP_ID"
