...
#LCO_ACC_PDP,AREA_CODE,BOUQUET_ID_NDS,BOUQUET_ID_HD_NDS,BOUQUET_ID_VM,BOUQUET_ID_HD_VM,BOUQUET_ID_JVM,BOUQUET_ID_HD_JVM,POP_ID
...
while ($line) 
{
    ...
    else 
    {
        ...
        ($ACC_PDP,$AREA_CODE,$BOUQUET_ID1,$BOUQUET_ID_HD1,$BOUQUET_ID2,$BOUQUET_ID_HD2,$BOUQUET_ID3,$BOUQUET_ID_HD3,$POP_ID) = split(/,/, $line);
