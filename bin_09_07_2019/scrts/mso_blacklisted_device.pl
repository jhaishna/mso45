...
#        print "\nInvalid input parameter";
        print "\nUsage1: mso_blacklisted_device.pl -input <input file name> ";
        print "\n       Ex: mso_blacklisted_device.pl -input input_file \n";
        exit 1;
}
...
#        print "Input parameter validation error\n";
        print "\nUsage2: mso_blacklisted_device.pl -input <input file name> ";
        print "\n       Ex: mso_blacklisted_device.pl -input input_file \n";
	exit 1;
}
...
;
			...
			# WRITE fields
			#======================================================
			&log ($DEBUG, "Updating MSO_FLD_CAS_SUBSCRIBER_ID from $cas_subscriber_id to DUMMY_BL" );
              my $write_flds_iflist = << "END"
0 MSO_FLD_CATV_INFO          SUBSTRUCT [0] allocated 20, used 9
1     MSO_FLD_CAS_SUBSCRIBER_ID    STR [0] "DUMMY_BL"
END
;
